...
PACKAGES=(
    ...
    dbus dbus-x11 pkexec mpg123 alsa-utils libnotify-bin aptitude
    notification-daemon smartmontools pulseaudio gvfs-backends arandr
    pnmixer mc lshw lsof sudo ncal ncdu htop apt-utils at upower menu menu-xdg
    ...
    imagemagick ips git mpv net-tools xclip gsimplecal hwinfo iftop jpegoptim
    ...
    arc-theme openbox tumbler pianobar orage gmrun gpicview gnome-characters
    ...
    xfce4-screenshooter gnome-icon-theme gimp bleachbit gifsicle synaptic geany
    geany-plugins fonts-noto-color-emoji ffmpegthumbnailer
)
